                ...
                AppSettings = new List<NameValuePairArgs>
                    {
                        ...
                        new NameValuePairArgs { Name = "Serilog:MinimumLevel:Override:Azure", Value = "Error" },
                        new NameValuePairArgs { Name = "Serilog:MinimumLevel:Override:Host.Controllers.Host", Value = "Error" },
